...
const StatsCard = ({ icon: Icon, title, value, change, changeType, delay = 0 }: StatsCardProps) => {
  ...
  return (
    <div className="relative group">
      ...
      <div className="relative bg-card/80 backdrop-blur-sm border border-border rounded-2xl p-6 shadow-glass hover:shadow-elevated transition-all duration-300 min-h-[8rem]">
